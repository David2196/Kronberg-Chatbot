        ...
        <div style={{ width: "100%", maxWidth: "780px", borderTop: "1px solid #1e1e1e", padding: "16px 32px 24px" }}>
          {sessionEnded ? (
            <div style={{ textAlign: "center" }}>
              ...
              <button onClick={resetSession} style={{ padding: "10px 28px", background: "transparent", border: "1px solid #333", color: "#555", fontFamily: "Arial, sans-serif", fontSize: "11px", letterSpacing: "2px", textTransform: "uppercase", cursor: "pointer" }}>
                Neues Gespräch
              </button>
            </div>
          ) : (
              ...
              <div style={{ display: "flex", gap: "12px", alignItems: "flex-end" }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "8px", alignSelf: "stretch" }}>
                  <button
                    ...
                    style={{ flex: 1, padding: "0 22px", background: isLoading || !input.trim() ? "transparent" : "#8a7340", border: "1px solid", borderColor: isLoading || !input.trim() ? "#252525" : "#8a7340", color: isLoading || !input.trim() ? "#333" : "#0f0f0f", fontFamily: "Arial, sans-serif", fontSize: "11px", letterSpacing: "1.5px", textTransform: "uppercase", cursor: isLoading || !input.trim() ? "default" : "pointer", whiteSpace: "nowrap" }}
                  >
                    Senden
                  </button>
                  <button
                    ...
                    style={{ flex: 1, padding: "0 22px", background: "transparent", border: "1px solid", borderColor: isLoading || messages.length < 3 ? "#1e1e1e" : "#5a2a2a", color: isLoading || messages.length < 3 ? "#2a2a2a" : "#8a4040", fontFamily: "Arial, sans-serif", fontSize: "11px", letterSpacing: "1.5px", textTransform: "uppercase", cursor: isLoading || messages.length < 3 ? "default" : "pointer", whiteSpace: "nowrap" }}
                  >
                    Beenden & Bewerten
                  </button>
                </div>
